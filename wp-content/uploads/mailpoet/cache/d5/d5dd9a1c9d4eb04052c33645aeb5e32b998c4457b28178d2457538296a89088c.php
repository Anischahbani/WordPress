...
/* settings/mta.html */
class __TwigTemplate_cf128517c20e8a27b09fc33a640e5382231d9ff7d79899444ee54de8b49341dc extends Twig_Template
{
      ...
      <tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["interval"]) {
            ...
            echo "\"
                ";
            // line 295
            if (( !$this->getAttribute($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "mta", array()), "frequency", array()), "interval", array()) && (            // line 296
      ...
      <tr class=\"mailpoet_smtp_field\" data-field=\"authentication\"
        ...
        <td>
          <label>
            ...
            ";
        // line 584
        if (( !$this->getAttribute($this->getAttribute(($context["settings"] ?? null), "mta", array()), "authentication", array()) || ($this->getAttribute($this->getAttribute(        // line 585
...
";
    ...
    {
        return new Twig_Source("", "settings/mta.html", "C:\\xampp\\htdocs\\WP2018\\WordPress\\wp-content\\plugins\\mailpoet\\views\\settings\\mta.html");
    }
}
